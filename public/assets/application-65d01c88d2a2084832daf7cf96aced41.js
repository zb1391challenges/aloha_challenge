...
(function() {
  jQuery(function() {
    var updateCircles, updateDiameter;
    updateDiameter = function(circle) {
      var bodyWidth, newDiameter;
    ...
    updateCircles = function() {
      var circle, circles, i, len, results;
      circles = $('.circle');
      results = [];
      for (i = 0, len = circles.length; i < len; i++) {
        circle = circles[i];
        results.push(updateDiameter(circle));
      }
      return results;
    };
    updateCircles();
    return window.onresize = updateCircles;
  });
